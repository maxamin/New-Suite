    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.frontend.sections*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ request()->path() == 'admin/frontend/frontend-sections/community' ? 'active' : '' }}">
                                <a href="{{route('admin.frontend.sections', 'community')}}" class="nav-link ">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{ request()->path() == 'admin/frontend/frontend-sections/blog' ? 'active' : '' }}">
                            ...
                            <li class="sidebar-menu-item {{ request()->path() == 'admin/frontend/frontend-sections/testimonial' ? 'active' : '' }}">
                                <a href="{{route('admin.frontend.sections', 'testimonial')}}" class="nav-link ">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Terms and Conditions')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.trade.level.all')}}">
                    <a href="{{route('admin.trade.level.all')}}" class="nav-link">
                        <i class="menu-icon las la-bars"></i>
                        <span class="menu-title">@lang('Trade Levels')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item {{menuActive('admin.plan.*')}}">
                    <a href="{{route('admin.plan.index')}}" class="nav-link">
                        <i class="menu-icon las la-bars"></i>
                        <span class="menu-title">@lang('Robots Plan')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.mining.index')}}">
                    <a href="{{route('admin.mining.index')}}" class="nav-link">
                        ...
                        <span class="menu-title">@lang('Ai Trade Setting')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.coin.index')}}">
                    <a href="{{route('admin.coin.index')}}" class="nav-link">
                        <i class="menu-icon las la-coins"></i>
                        <span class="menu-title">@lang('Coin Setting')</span>
                    </a>
                </li>
