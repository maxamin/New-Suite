                ...
                <div class="card-body">
                    <form id="userInfoForm" action="{{route('admin.users.update',[$user->id])}}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('Achievement Message') </label>
                                    <div class="input-group ">
                                        <input type="text" name="achievement" value="{{$user->achievement}}" id="achievement" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group ">
                                        <input type="text" name="withdraw_wallet" value="{{@$user->withdraw_wallet}}" id="withdraw_wallet" class="form-control">
                                    </div>
                                </div>
                            </div>
