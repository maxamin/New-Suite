                                    ...
                                    <tr>
                                        ...
                                        <td data-label="@lang('Action')">
                                            <button class="btn btn-outline--primary btn-sm planBtn"
                                                ...
                                                data-stop_charge="{{ getAmount($plan->stop_charge) }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control has-append" name="price" id="price" placeholder="@lang('Price of Plan')" required>
                                <div class="input-group-text">{{ $general->cur_text }}</div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="stop_charge">@lang('Trade Stop Charge') </label>
                            <div class="input-group">
                                <input type="number" class="form-control has-append" name="stop_charge" id="stop_charge" placeholder="@lang('Trade Stop Charge')" required>
                                <div class="input-group-text">{{ $general->cur_text }}</div>
                            </div>
                        </div>
                        <div class="form-group" hidden>
                            <label for="daily_limit">@lang('Daily Ad Limit')</label>
                            <input type="number" class="form-control" name="daily_limit" id="daily_limit" value="1" placeholder="@lang('Daily Ad Limit')" required>
                        </div>
                        <div class="form-group">
                            <label for="ads_rate">@lang('Daily Profit')</label>
                            <div class="input-group">
...
@push('script')
    <script>
        ...
        $(document).on('click','.planBtn', function (e) {
            ...
            modal.find('input[name=stop_charge]').val($(this).data('stop_charge'));
