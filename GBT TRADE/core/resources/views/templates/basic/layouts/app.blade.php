    ...
    <script>
        ...
        const darkModeChange = () => {
            if($('body').hasClass('darkmode')){
                $('.nightModeImg').html(`<img width="28px" src="{{asset('assets/images/new-logo-3d/sun.png')}}" alt="">`);
            }else{
                $('.nightModeImg').html(`<img width="28px" src="{{asset('assets/images/new-logo-3d/cloud.png')}}" alt="">`);
            }
        }
