                        ...
                        <div class="col-12 align-self-center mb-4">
                            <div class="row justify-content-center">
                                <div class="col-11 col-sm-7 col-md-6 col-lg-5 col-xl-4">
                                    ...
                                    <div class="form-group float-label">
                                        <input class="form-control  checkUser" id="firstname" name="firstname" type="text" value="{{ old('firstname') }}" required>
                                        <label class="form-control-label "><i class="las la-user-tag"></i> First name</label>
                                    </div>

                                    <div class="form-group float-label">
                                        <input class="form-control  checkUser" id="lastname" name="lastname" type="text" value="{{ old('lastname') }}" required>
                                        <label class="form-control-label "><i class="las la-user-tag"></i> Last name</label>
                                    </div>
                                    ...
                                    {{-- <div class="form-group float-label active">
                                        <input class="form-control  checkUser" id="email" name="email" type="email" value="{{ session()->get('email') }}" required>
                                    ...
                                    <input type="hidden" name="mobile" value="{{ session()->get('number') }}">
                                    <input type="hidden" name="country_code" value="{{ session()->get('country_code') }}">
                                    <input type="hidden" name="mobile_code" value="{{ session()->get('dial_code') }}">
                                    ...
                                    {{-- <div class="form-group float-label active">
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control checkUser" aria-label="Default" aria-describedby="inputGroup-sizing-default" id="mobile" name="mobile" type="number" value="{{ session()->get('number') }}" required>
                                        </div>
...
@push('script')
    <script>
        ...
        (function($) {
            ...
            $('.checkRefBy').on('keyup', function (e) {
