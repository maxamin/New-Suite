                        ...
                        <div class="d-flex flex-wrap gap-4">
                            ...
                            <div class="flex-grow-1 p-1">
                                ...
                                <select class="form-control form-select" name="remark">
                                    ...
                                    <option value="plan_subscribe_commission">@lang('Robot Buy Commission')</option>
                                    <option value="ptc_view_commission">@lang('Ai Trading Commission')</option>
                                </select>
                            </div>
                        ...
                        <div class="col-auto">
                          ...
                          <h6 class="text-light">
                            ...
                            @elseif($log->type == 'plan_subscribe_commission')
                                <span class="badge badge-warning">@lang('Buy Robots')</span>
                            @else
                                <span class="badge badge-danger">@lang('Ai Trade')</span>
                            @endif
