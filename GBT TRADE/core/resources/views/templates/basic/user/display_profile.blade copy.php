                ...
                <div class="card-header pb-0 mt-2">
                    <div class="row align-items-end">
                        <div class="col-4 text-left">
                            ...
                            <h6 class="mb-0 text-no-shadow font-sm">Current Balance</h6>
                    ...
                    <div class="row align-items-center">
                        <div class="col-4 text-center">
                            <div class="card-item" data-toggle="modal" data-target="#depositModal">
                                <img src="{{asset('assets/images/new-logo-3d/deposit-2.png')}}" alt="">
                                <p>Deposit</p>
                            </div>
                        </div>
                        <div class="col-4 text-center">
                            <div class="card-item"
                                ...
                                @endif >
                                <img src="{{asset('assets/images/new-logo-3d/record.png')}}" alt="">
                                <p>Transfer</p>
                            </div>
                        </div>
                        <div class="col-4 text-center">
                            <div class="card-item" data-toggle="modal" data-target="#withdrawModal">
                                <img src="{{asset('assets/images/new-logo-3d/withdraw-2.png')}}" alt="">
                                <p>Withdraw</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row align-items-top">
                                ...
                                {{-- <div class="col-3 text-center pr-1 mt-2">
                                    <a href="{{ route('user.withdraw.wallet') }}" class="card-box">
                                        <img src="{{asset('assets/images/new-logo-3d/wallet.png')}}" alt="">
                                        <p>W-Address</p>
                                    </a>
                                </div> --}}
                            </div>
