...
class RegisterController extends Controller
{
    ...
    */
    ...
    protected function create(array $data)
    {
        ...
        if ($referBy) {
            $referUser = User::where('id', ( $referBy-10000 ))->first();
        } else {
            $referUser = null;
        }
        //User Create
        ...
        $user->firstname = @$data['firstname'] ? @$data['firstname'] : $data['username'];
        $user->lastname = @$data['lastname'] ? @$data['lastname'] : ' ';
        $user->username = trim($data['username']);
        $user->ref_by = $referUser ? $referUser->id : 0;
        $user->country_code = @$data['country_code'] ? @$data['country_code'] : 'BD';
        $user->mobile = @$data['mobile_code'] ? @$data['mobile_code'] : 880 . @$data['mobile'];
        // $user->mobile = @$data['mobile_code'] ? @$data['mobile_code'] : 880 . @$data['mobile'] ? @$data['mobile'] : null;
        // $user->address = [
        //     'address' => '',
        //     'state' => '',
        //     'zip' => '',
    ...
    public function checkUser(Request $request){
        ...
        if ($request->referBy) {
            $exist['data'] = User::where('id', ($request->referBy-10000))->exists();
            $exist['type'] = 'referBy';
        }
        // if ($request->referBy) {
