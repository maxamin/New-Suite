...
use App\Http\Controllers\CustomCoinController;
use App\Http\Controllers\TradeLavelController;
use App\Http\Controllers\AutoPaymentController;


Route::middleware('web2')->prefix('admin')->name('admin.')->group(function(){
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::name('trade.')->prefix('trade')->group(function (){
            Route::get('all', [TradeLavelController::class, 'index'])->name('level.all');
            Route::post('store', [TradeLavelController::class, 'store'])->name('level.store');
        });
        ...
        Route::controller('GeneralSettingController')->group(function () {
            ...
            // Mining Setting
            Route::get('mining-setting', 'miningSetting')->name('mining.index');
            Route::post('mining-setting', 'miningSettingUpdate')->name('mining.update');

            // custom coin manage
            Route::get('coin-setting', [CustomCoinController::class, 'coinSetting'])->name('coin.index');
            Route::post('coin-setting', [CustomCoinController::class, 'coinSettingUpdate'])->name('coin.update');
