                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border--primary mt-3">
                                            ...
                                            <h5 class="card-header bg--primary"><?php echo app('translator')->get('Deposit Information'); ?></h5>
                                            <div class="card-body">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="admin_number" value="<?php echo e(@$method->singleCurrency->admin_number); ?>" placeholder="Enter Admin Payment Number/Address" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hemelmridha/public_html/miningjs.demo4k.xyz/core/resources/views/admin/gateways/manual/create.blade.php ENDPATH**/ ?>