...
<div class="cmn-section">
    <div class="container">
        <div class="row justify-content-center mt-4">
            <div class="col-md-12">
                <div class="text-end">
                    <a href="<?php echo e(route('ticket.index')); ?>" class="btn btn-sm btn--base mb-2"><?php echo app('translator')->get('My Support Ticket'); ?></a>
                </div>
...
<?php echo $__env->make($activeTemplate.'layouts.mobile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hemelmridha/public_html/miningjs.demo4k.xyz/core/resources/views/templates/basic/user/support/create.blade.php ENDPATH**/ ?>