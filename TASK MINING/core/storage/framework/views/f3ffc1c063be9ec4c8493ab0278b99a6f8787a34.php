            ...
            <div class="header-wrapper">
                ...
                <div class="menu-area">
                    <ul class="menu menu--style1">
                        ...
                        <li><a href="<?php echo e(route('user.trading')); ?>"><?php echo app('translator')->get('Trading'); ?></a></li>
...
<?php /**PATH /home/hemelmridha/public_html/miningjs.demo4k.xyz/core/resources/views/templates/basic/partials/user/header.blade.php ENDPATH**/ ?>