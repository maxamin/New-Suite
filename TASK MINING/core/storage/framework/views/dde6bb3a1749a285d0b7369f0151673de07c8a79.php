    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-7">
                <div class="bg-light rounded p-2">
                    <div class="row">
                        <div class="col pe-0">
                            <span class="mb-0 fw-bold text-secondary"><?php echo e($general->cur_sym); ?></span>
        ...
        <form action="" method="post" class="needs-validation" novalidate>
            <div class="row align-items-center mt-3">
                ...
                <div class="col-7">
                    <input type="text" name="send_money_form" class="form-control" placeholder="এখান থেকে সেন্ড মানি করবেন" required>
...
<?php /**PATH /Users/mrorko/Sites/miningJs/core/resources/views/templates/basic/user/payment/custom/checkout.blade.php ENDPATH**/ ?>