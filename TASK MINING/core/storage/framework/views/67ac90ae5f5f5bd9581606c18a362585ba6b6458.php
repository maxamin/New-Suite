            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" name="level" min="1" value="3" placeholder="Type a number & hit ENTER ↵" class="form-control" readonly>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ethemest/DEMO/demo.viser.store/usdt-trading/core/resources/views/admin/referral_setting.blade.php ENDPATH**/ ?>