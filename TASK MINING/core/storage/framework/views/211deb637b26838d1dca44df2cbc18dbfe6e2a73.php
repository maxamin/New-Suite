<?php $__env->startSection('panel'); ?>
    <div class="row gy-4">
        ...
        <?php if($extraTemplates): ?>
            <?php $__currentLoopData = $extraTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-3">
                    <div class="card">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mrorko/Sites/ptclab-new-look/core/resources/views/admin/frontend/templates.blade.php ENDPATH**/ ?>