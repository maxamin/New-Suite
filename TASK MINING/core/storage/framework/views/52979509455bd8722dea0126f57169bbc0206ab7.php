                ...
                <div class="col-6">
                    ...
                    <?php else: ?>
                        <a href="#" id="collectBtn" class="btn btn-success btn-sm w-100 collectProfit">Collect -
                            <?php echo e($general->cur_sym); ?><?php echo e($user->plan->daily_profit); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php echo $__env->make($activeTemplate . 'layouts.mobile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mrorko/Sites/whiteTrading/core/resources/views/templates/basic/user/trading/index.blade.php ENDPATH**/ ?>