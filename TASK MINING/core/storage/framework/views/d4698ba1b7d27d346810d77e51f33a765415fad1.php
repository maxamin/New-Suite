            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" value="<?php echo e(route('user.register')); ?>?inviteCode=<?php echo e(refCode_encode($user->id)); ?>"
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-4 text-center">
                        ...
                        <h5 class="mb-0 small-font-lg text-primary fw-bold"><?php echo e(getAmount(refTotalDeposit($user->id))); ?> <?php echo e($general->cur_text); ?></h5>
                    </div>
                    <div class="col-4 text-center">
                        <h6 class="mb-0 small-font-sm text-light">Team Total Withdrawals</h6>
                        <h5 class="mb-0 small-font-lg text-primary fw-bold"><?php echo e(getAmount(refTotalWithdraw($user->id))); ?> <?php echo e($general->cur_text); ?></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-6 text-center">
                        ...
                        <h5 class="mb-0 text-light mid-font-sm fw-bold"><?php echo e(getAmount(profitAmount($user->id, 1))); ?> <?php echo e($general->cur_text); ?></h5>
                    </div>
                    <div class="col-12 text-center mt-3">
                        <a href="<?php echo e(route('user.refer.users', 1)); ?>" class="btn btn-sm btn-light rounded-pill px-5">Details</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="card mt-3 bg-gr-green-light">
            <div class="card-body">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-6 text-center">
                        <h6 class="mb-0 text-light small-font-lg">Profit Amount</h6>
                        <h5 class="mb-0 text-light mid-font-sm fw-bold"><?php echo e(getAmount(profitAmount($user->id, 2))); ?> <?php echo e($general->cur_text); ?></h5>
                    </div>
                    <div class="col-12 text-center mt-3">
                        <a href="<?php echo e(route('user.refer.users', 2)); ?>" class="btn btn-sm btn-light rounded-pill px-5">Details</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="card mt-3 bg-gr-violet">
            <div class="card-body">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-6 text-center">
                        <h6 class="mb-0 text-light small-font-lg">Profit Amount</h6>
                        <h5 class="mb-0 text-light mid-font-sm fw-bold"><?php echo e(getAmount(profitAmount($user->id, 3))); ?> <?php echo e($general->cur_text); ?></h5>
                    </div>
                    <div class="col-12 text-center mt-3">
                        <a href="<?php echo e(route('user.refer.users', 3)); ?>" class="btn btn-sm btn-light rounded-pill px-5">Details</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make($activeTemplate.'layouts.mobile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zekisoft/earnlite.tezdayukla.uz/core/resources/views/templates/basic/user/referred_team.blade.php ENDPATH**/ ?>