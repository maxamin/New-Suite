...
<style>
    ...
    <div id="appCapsule">
        ...
        <div class="container-fluid mt-2 bg-dark-alt">
            <div class="row py-2">
                <a href="<?php echo e(route('user.onepay.index')); ?>" class="col-3 px-0 text-center">
...
<?php echo $__env->make($activeTemplate . 'layouts.mobile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hemelmridha/public_html/miningjs.demo4k.xyz/core/resources/views/templates/basic/home.blade.php ENDPATH**/ ?>