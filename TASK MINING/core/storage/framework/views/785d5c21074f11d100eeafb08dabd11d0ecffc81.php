            ...
            <div class="story__thumb">
                <div class="story__thumb-inner" data-aos="fade-up" data-aos-duration="800">
                    ...
                    <div class="story__thumb-playbtn">
                        <a href="<?php echo e(__($aboutCaption->data_values->video_url)); ?>" data-fslightbox>
...
<div class="container mt-4">
    <h5 class="text-center mb-0">
        <a href="https://t.me/" class="text--primary"><i class="fa-solid fa-paper-plane"></i> Join Telegram</a>
    </h5>
</div>
                    ...
                    <div class="about__thumb pe-lg-5" data-aos="fade-right" data-aos-duration="800">
                        <div class="about__thumb-inner">
                            <div class="about__thumb-image floating-content">
                                <img class="" src="<?php echo e(getImage('assets/images/frontend/about/'.$aboutCaption->data_values->image)); ?>" alt="about-image">
...
<!-- ===============>> cta section start here <<================= -->
<?php /**PATH /Users/mrorko/Sites/newTrading/core/resources/views/templates/basic/sections/about.blade.php ENDPATH**/ ?>