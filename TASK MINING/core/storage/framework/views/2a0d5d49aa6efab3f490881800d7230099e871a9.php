        ...
        <div class="row justify-content-center gy-4">
            ...
            <div class="col-md-6">
                <div class="card custom--card">
                    <div class="card-header">
                        <h5 class="title"><?php echo app('translator')->get('Add Your Account'); ?></h5>
                    </div>
            ...
            <div class="col-md-6">
                ...
                <?php if(auth()->user()->ts): ?>
                    <div class="card custom--card">
                        <div class="card-header">
                            <h5 class="title"><?php echo app('translator')->get('Disable 2FA Security'); ?></h5>
                        </div>
                ...
                <?php else: ?>
                    <div class="card custom--card">
                        <div class="card-header">
                            <h5 class="title"><?php echo app('translator')->get('Enable 2FA Security'); ?></h5>
                        </div>
...
<?php echo $__env->make($activeTemplate.'layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mrorko/Sites/ptclab-new-look/core/resources/views/templates/basic/user/twofactor.blade.php ENDPATH**/ ?>