...
<section class="cmn-section">
    <div class="container">
        <div class="row cmn-text">
                ...
                <div class="widget-two h-100 box--shadow2 b-radius--5 bg--white">
                    ...
                    <div class="widget-two__content">
                        ...
                        <a href="<?php echo e(route('user.withdraw')); ?>"
                                class="btn cmn-btn"><?php echo app('translator')->get('Withdraw Now'); ?> <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div><!-- widget-two end -->
            </div>
            <div class="col-md-6 mb-30">
                <div class="widget-two h-100 box--shadow2 b-radius--5 bg--white">
                    ...
                    <div class="widget-two__content">
                        ...
                        <a href="<?php echo e(route('plans')); ?>" class="btn cmn-btn"><?php if($user->expire_date >= now()): ?> <?php echo app('translator')->get('Change Plan'); ?> <?php else: ?> <?php echo app('translator')->get('Choose Plan'); ?> <?php endif; ?> <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
            ...
            <a href="<?php echo e(route('user.ptc.clicks')); ?>" class="col-lg-6 col-md-12 mb-30">
                <div class="widget bb--3 border--success b-radius--10 bg--white p-2 pt-3 box--shadow2">
                    ...
                    <div class="widget__content">
                        <p class="text-uppercase text-muted mb-0"><?php echo app('translator')->get('Total Clicks'); ?></p>
                        <h2 class="text--base fw-bold"><?php echo e($user->clicks->count()); ?></h2>
                    </div>
            ...
            <a href="<?php echo e(route('user.ptc.index')); ?>" class="col-lg-6 col-md-12 mb-30">
                <div class="widget bb--3 border--success b-radius--10 bg--white p-2 pt-3 box--shadow2">

                    <div class="widget__icon b-radius--rounded bg--success"><i class="fas fa-calendar-alt"></i></div>
                    <div class="widget__content">
                        <p class="text-uppercase text-muted mb-0"><?php echo app('translator')->get('Remain clicks for today'); ?></p>
            ...
            <a href="<?php echo e(route('user.ptc.clicks')); ?>" class="col-lg-6 col-md-12 mb-30">
                <div class="widget bb--3 border--success b-radius--10 bg--white p-2 pt-3 box--shadow2">
                    <div class="widget__icon b-radius--rounded bg--success"><i class="fas fa-mouse-pointer"></i></div>
                    <div class="widget__content">
                        <p class="text-uppercase text-muted mb-0"><?php echo app('translator')->get("Today's Clicks"); ?></p>
                        <h2 class="text--base fw-bold">
            ...
            <a href="<?php echo e(route('user.ptc.ads')); ?>" class="col-lg-6 col-md-12 mb-30">
                <div class="widget bb--3 border--success b-radius--10 bg--white p-2 pt-3 box--shadow2">
                    <div class="widget__icon b-radius--rounded bg--success"><i class="fas fa-mouse-pointer"></i></div>
                    <div class="widget__content">
                        <p class="text-uppercase text-muted mb-0"><?php echo app('translator')->get("My Active ADS"); ?></p>
                        <h2 class="text--base fw-bold">
...
<?php echo $__env->make($activeTemplate.'layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mrorko/Sites/ptclab-new-look/core/resources/views/templates/basic/user/dashboard.blade.php ENDPATH**/ ?>