        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="<?php echo e(menuActive('admin.ptc.*', 3)); ?>">
                        <i class="menu-icon las la-ad"></i>
                        <span class="menu-title"><?php echo app('translator')->get('PTC Ads'); ?></span>
                        <?php if($pendingPtcCount > 0): ?>
                            <span class="menu-badge pill bg--danger ms-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        <?php endif; ?>
                    </a>
                    <div class="sidebar-submenu <?php echo e(menuActive('admin.ptc.*', 2)); ?> ">
                        <ul>
                            <li class="sidebar-menu-item <?php echo e(menuActive('admin.ptc.index')); ?> ">
                                <a href="<?php echo e(route('admin.ptc.index')); ?>" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title"><?php echo app('translator')->get('All'); ?></span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item <?php echo e(menuActive('admin.ptc.active')); ?> ">
                                <a href="<?php echo e(route('admin.ptc.active')); ?>" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title"><?php echo app('translator')->get('Active'); ?></span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item <?php echo e(menuActive('admin.ptc.inactive')); ?> ">
                                <a href="<?php echo e(route('admin.ptc.inactive')); ?>" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title"><?php echo app('translator')->get('Inactive'); ?></span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item <?php echo e(menuActive('admin.ptc.pending')); ?> ">
                                <a href="<?php echo e(route('admin.ptc.pending')); ?>" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title"><?php echo app('translator')->get('Pending'); ?></span>
                                    <?php if($pendingPtcCount): ?>
                                        <span class="menu-badge pill bg--danger ms-auto"><?php echo e($pendingPtcCount); ?></span>
                                    <?php endif; ?>
                                </a>
                            </li>
                            <li class="sidebar-menu-item <?php echo e(menuActive('admin.ptc.rejected')); ?> ">
                                <a href="<?php echo e(route('admin.ptc.rejected')); ?>" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="<?php echo e(menuActive('admin.ptcreport*', 3)); ?>">
                        <i class="menu-icon las la-flag"></i>
                        <span class="menu-title"><?php echo app('translator')->get('PTC Reports'); ?></span>
                    </a>
                    <div class="sidebar-submenu <?php echo e(menuActive('admin.ptcreport*', 2)); ?>">
                        <ul>
                            <li class="sidebar-menu-item <?php echo e(menuActive('admin.ptcreport.type')); ?>">
                                <a href="<?php echo e(route('admin.ptcreport.type')); ?>" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title"><?php echo app('translator')->get('Report Type'); ?></span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item <?php echo e(menuActive('admin.ptcreport.logs')); ?>">
                                <a href="<?php echo e(route('admin.ptcreport.logs')); ?>" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title"><?php echo app('translator')->get('Report Logs'); ?></span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu <?php echo e(menuActive('admin.report*', 2)); ?> ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item <?php echo e(menuActive('admin.report.ptcview')); ?>">
                                <a href="<?php echo e(route('admin.report.ptcview')); ?>" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title"><?php echo app('translator')->get('PTC View Log'); ?></span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item <?php echo e(menuActive('admin.setting.ads')); ?>">
                    <a href="<?php echo e(route('admin.setting.ads')); ?>" class="nav-link">
                        <i class="menu-icon las la-tags"></i>
                        <span class="menu-title"><?php echo app('translator')->get('Ads Setting'); ?></span>
                    </a>
                </li>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/mrorko/Sites/ptclab-new-look/core/resources/views/admin/partials/sidenav.blade.php ENDPATH**/ ?>