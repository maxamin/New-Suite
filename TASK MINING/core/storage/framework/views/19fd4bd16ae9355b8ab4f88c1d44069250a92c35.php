        ...
        <div class="col-xl-8 col-md-6 mb-30">
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    <?php if(@$deposit->user_number): ?>
                        <h6>Sending Number</h6>
                        <p><?php echo e($deposit->user_number); ?></p>
                    <?php endif; ?>
                    <?php if(@$deposit->transaction_id): ?>
                        <h6>Transaction Id</h6>
                        <p><?php echo e($deposit->transaction_id); ?></p>
                    <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hemelmridha/public_html/miningjs.demo4k.xyz/core/resources/views/admin/deposit/detail.blade.php ENDPATH**/ ?>