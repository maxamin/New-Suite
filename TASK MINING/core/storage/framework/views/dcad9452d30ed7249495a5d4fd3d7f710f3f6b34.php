                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control iconPicker icon" value="<?php echo e(@$content->data_values->$k); ?>" autocomplete="off" name="<?php echo e($k); ?>" required>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ethemest/DEMO/demo.viser.store/usdt-trading/core/resources/views/admin/frontend/index.blade.php ENDPATH**/ ?>