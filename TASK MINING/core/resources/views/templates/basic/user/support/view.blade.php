                            ...
                            @foreach ($messages as $message)
                                @if ($message->admin_id == 0)
                                    <div class="row border border-primary rounded border-radius-3 my-3 py-3 mx-2">
                                        <div class="col-md-3 border-end text-end">
                                            <h5 class="my-3 small-font-lg text-light">{{ $message->ticket->name }}</h5>
                                        </div>
                                        <div class="col-md-9">
                                ...
                                @else
                                    <div class="row border border-warning rounded border-radius-3 my-3 py-3 mx-2" style="background-color: #ffd96729">
                                        <div class="col-md-3 border-end text-end">
                                            <h5 class="my-3 small-font-lg text-light">{{ $message->admin->name }}</h5>
                                            <p class="lead text-info small-font">@lang('Staff')</p>
                                        </div>
                                        <div class="col-md-9">
                                            <p class="small-font-lg text-secondary my-3">
                                                @lang('Posted on') {{ $message->created_at->format('l, dS F Y @ H:i') }}</p>
