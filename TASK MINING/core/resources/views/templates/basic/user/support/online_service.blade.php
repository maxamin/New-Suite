        ...
        <div class="card bg-gr-green-light-alt">
            <div class="card-body p-3">
                <div class="row align-items-center">
                    <div class="col-auto">
                        <img style="width: 50px" src="{{asset('assets/images/3d-logo/support-24.png')}}" alt="">
                    </div>
                    <div class="col text-end">
                        <h5 class="mb-1 small-font-lg text-light">Customer Service</h5>
                        <a href="{{@$inportentLinks->data_values->customer_service_telegram}}" class="btn btn-mini btn-light rounded-pill">
                            Contact Us
                        </a>
                    </div>
                </div>
            ...
            <div class="card-body p-3">
                <div class="row align-items-center">
                    ...
                    <div class="col text-end">
                        ...
                        <a href="{{@$inportentLinks->data_values->telegram_group}}" class="btn btn-mini btn-light rounded-pill">
                            Join
                        </a>
                    </div>
                </div>
