    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 text-center mt-1">
                <img width="150px" src="{{ asset('assets/images/logoIcon/logo.png') }}" alt="">
            </div>
        </div>
        
        <table width="100%"  style="padding-top:35px;">
<tr align="center">
    <td width="40%"> <a href="{{ route('user.register') }}" class="btn btn-lg btn-dark w-100 rounded-pill mt-3" style="line-height:35px;">Register</a></td>
<td width="40%"> <a href="{{ route('user.login') }}" class="btn btn-lg bg-gr-orange btn-primary w-100 rounded-pill mt-3"style="line-height:35px;">Login</a></td>
        ...
        <form action="{{ route('user.login') }}" method="POST" class="mt-4 form-login">
            @csrf
            <div class="mb-3">
