                ...
                <form action="{{route('user.bank.card.store')}}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="bank_id">
                            <option selected value="{{null}}">Select Network</option>
                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <h6 class="text-primary small-font-lg">
                                    {{$myMethod ? $myMethod->name : 'N/A'}}
                                </h6>
                                <h6 class="text-secondary small-font-sm mt-2">
                                    USDT Wallet Adress:
                                </h6>
                                <h6 class="text-primary small-font-lg">{{ $bank_card['account_number'] }}</h6>
                            </div>
            ...
            iziToast.question({
                ...
                buttons: [
                    ['<button><b>YES</b></button>', function () {
                        location.href = "{{ route('user.bank.card.remove') }}"
                    }],
