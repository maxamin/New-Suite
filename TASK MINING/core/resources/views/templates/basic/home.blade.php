    ...
    <div id="appCapsule">
            ...
            <div class="swiper-wrapper">
                ...
                @foreach ($banners as $item)
                    <div class="swiper-slide">
                        <img width="100%" style="height: 200px;" src="{{ asset('assets/images/frontend/banner/' . $item->data_values->image) }}" alt="">
                    </div>
                @endforeach
            </div>
        ...
        <div class="card border  border-2 border-secondary bg-gr-orange">
             <div class="row py-3">
                ...
                <a href="{{route('user.invite')}}" class="col-3 px-0 text-center">
        ...
        <!-- Popup modal -->
        @include('templates.basic.modal.popup')
