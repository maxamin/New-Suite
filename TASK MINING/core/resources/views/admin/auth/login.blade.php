                ...
                <div class="login-area">
                    <div class="login-wrapper">
                        ...
                        <div class="login-wrapper__body">
                            <h3 class="title text-white text-center">@lang('Admin Panel')</h3>
                            <h3 class="title text-white text-center">@lang('Welcome to') <strong>{{ __($general->site_name) }}</strong></h3>
                            <form action="{{ route('admin.login') }}" method="POST" class="cmn-form mt-30 verify-gcaptcha login-form">
                                ...
                                <button type="submit" class="btn btn-lg btn--primary border-0 w-100 mt-3">@lang('LOGIN')</button>
                            </form>
                        </div>
                    </div>
                </div>
