    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.frontend.sections*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ request()->path() == 'admin/frontend/frontend-sections/popup' ? 'active' : '' }}">
                                <a href="{{route('admin.frontend.sections', 'popup')}}" class="nav-link ">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Popup Notice')</span>
                                </a>
                            </li>
            ...
            {{-- <div class="text-center mb-3 text-uppercase">
                ...
                <h6 class="text-white">by <a target="_blank" href="https://t.me/iam_mrHemel">H E M E L</a></h6>
            </div> --}}
        </div>
    </div>
</div>
