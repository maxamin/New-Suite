                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control iconPicker icon" value="{{ @$content->data_values->$k}}" autocomplete="off" name="{{ $k }}" required>
...
<link href="{{ asset('assets/templates/ptc_diamond/css/lib/custom-icon.css') }}" rel="stylesheet">
@endpush
