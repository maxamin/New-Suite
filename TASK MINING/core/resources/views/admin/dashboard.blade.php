...
<div class="row gy-4">
    <div class="col-xxl-6 col-sm-6">
        <x-widget
            ...
            image="{{asset('assets/images/3d-logo/team-3.png')}}"
            title="Total Users"
    ...
    <div class="col-xxl-6 col-sm-6">
        <x-widget
            ...
            image="{{asset('assets/images/3d-logo/user-6.png')}}"
...
<div class="row gy-4 mt-2">
    <div class="col-xxl-6 col-sm-6">
        <x-widget
            ...
            image="{{asset('assets/images/3d-logo/deposit.png')}}"
            icon_style="false"
    ...
    <div class="col-xxl-6 col-sm-6">
        <x-widget
            ...
            icon="fas fa-spinner"
            image="{{asset('assets/images/3d-logo/clock-3.png')}}"
            icon_style="false"
    ...
    <div class="col-xxl-6 col-sm-6">
        <x-widget
            ...
            icon="fas fa-ban"
            image="{{asset('assets/images/3d-logo/lose.png')}}"
            icon_style="false"
    ...
    <div class="col-xxl-6 col-sm-6">
        <x-widget
            ...
            image="{{asset('assets/images/3d-logo/percent.png')}}"
            icon_style="false"
...
<div class="row gy-4 mt-2">
    <div class="col-xxl-6 col-sm-6">
        <x-widget
            ...
            image="{{asset('assets/images/3d-logo/wallet.png')}}"
    ...
    <div class="col-xxl-6 col-sm-6">
        <x-widget
            ...
            icon="las la-sync"
            image="{{asset('assets/images/3d-logo/clock.png')}}"
    ...
    <div class="col-xxl-6 col-sm-6">
        <x-widget
            ...
            image="{{asset('assets/images/3d-logo/payment-failed.png')}}"
...
{{-- <div class="row gy-4 mt-2">
    <div class="col-xxl-6 col-sm-6">
        <x-widget
            style="3"
            link="{{ route('admin.ptc.index') }}"
            icon="las la-ad"
            title="Total Ads"
            value="{{ showAmount($widget['total_ads']) }} {{ $general->cur_text }}"
            bg="primary"
        />
    </div><!-- dashboard-w1 end -->
    <div class="col-xxl-6 col-sm-6">
        <x-widget
            style="3"
            link="{{ route('admin.report.ptcview') }}"
            icon="las la-hand-pointer"
            title="Viewed Ads"
            value="{{ showAmount($widget['total_view']) }} {{ $general->cur_text }}"
            bg="1"
        />
    </div><!-- dashboard-w1 end -->
    <div class="col-xxl-6 col-sm-6">
        <x-widget
            style="3"
            link="{{ route('admin.report.commissions') }}"
            icon="las la-link"
            title="Referral Commissions"
            value="{{ showAmount($widget['referral_commissions']) }} {{ $general->cur_text }}"
            bg="14"
        />
    </div><!-- dashboard-w1 end -->
    <div class="col-xxl-6 col-sm-6">
        <x-widget
            style="3"
            link="{{ route('admin.report.transaction') }}?remark=subscribe_plan"
            icon="las la-list"
            title="Total Plan Purchased"
            value="{{ showAmount($widget['plan_purchased']) }} {{ $general->cur_text }}"
            bg="19"
        />
    </div><!-- dashboard-w1 end -->
</div><!-- row end--> --}}
