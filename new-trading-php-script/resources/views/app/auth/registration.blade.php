...
<link rel="stylesheet" href="{{asset('public')}}/pageCss/regsiter.css">
<style>
    .top {
        position: absolute;
    }
...
<form action="{{url('register')}}" method="post">
    ...
    <div class="center-panel login-bg">
        ...
        <div class="top">
            ...
            <div class="lang" style="width: 200px;text-align: right;">
                <span style="color: #fff;display: inline-block;margin-top: 8px;">Create Account</span>
            </div>
        </div>
        ...
        <div class="login-box">
            <div class="login-input-group">
                ...
                <div class="form-input-box login-input-box phone" style="background-color:#fff;">
                    <img class="login-input-icon" src="{{asset('public')}}/static/images/register/mobile.png?1" alt="">
                    <input class="form-input login-input-control" type="number" name="phone" maxlength="16" placeholder="please enter your phone number">
                </div>
            </div>

            <div class="login-input-group">
                <div class="label">Invitation code</div>
                <div class="form-input-box login-input-box" style="background-color:#fff;">
                    <img class="login-input-icon" src="{{asset('public')}}/static/images/register/code.png?1" alt="">
                    <input class="form-input login-input-control" type="text" name="ref_by" maxlength="15"
                           placeholder="Please enter your invitation code(optional)"
            ...
            <div class="login-input-group">
                ...
                <div class="form-input-box login-input-box" style="background-color:#fff;">
                    <img class="login-input-icon" src="{{asset('public')}}/static/images/register/password.png?1" alt="">
                    <input class="form-input login-input-control" name="password" type="password" maxlength="20" placeholder="Enter your password">
                    <img class="login-input-icon-right login-input-eye-ico" src="{{asset('public')}}/static/images/register/eye.png" alt="">
                </div>
            </div>
            ...
            <div class="login-input-group" style="margin-bottom: 20px;">
                ...
                <div class="form-input-box login-input-box" style="background-color:#fff;">
                    <img class="login-input-icon" src="{{asset('public')}}/static/images/register/password.png?1" alt="">
                    <input class="form-input login-input-control" name="password_confirm" type="password" maxlength="20" placeholder="Enter your confirm password">
                    <img class="login-input-icon-right login-input-eye-ico" src="{{asset('public')}}/static/images/register/eye.png" alt="">
                </div>
            </div>


            <button class="form-button" block="" type="button" id="login-btn">Register</button>

            <div class="tc fz13 login-footer-link" style="margin: 15px 0" onclick="go('{{url('login')}}')">Have an account? Login
                now
            </div>
            <div class="login-yinsi" style="margin-top: 0">
...
<script>
    // show password
    $('.login-input-eye-ico').on('click', function () {
        var type = $(this).prev('input').attr('type')
        if (type === 'text') {
            $(this).prev('input').attr('type', 'password')
            $(this).attr('src', "{{asset('public')}}/static/images/register/eye.png")
        } else {
            $(this).prev('input').attr('type', 'text')
            $(this).attr('src', "{{asset('public')}}/static/images/register/eye-close.png")
        }
    });
    ...
    $('#login-btn').click(function () {
        ...
        if (!password.length)
            return message("Please create your password")

        if (!password_confirm.length)
            return message("Please confirm your password")

        if (password_confirm != password)
            return message("The password entered twice is inconsistent");
...
<script type="text/javascript" src="{{asset('public')}}/static/js/country.js?1"></script>
...
<div id="float_ico"
     style="position: fixed; bottom: 105px; right: 10px; display: flex; justify-content: center; align-items: center; width: 48px; height: 48px;">
