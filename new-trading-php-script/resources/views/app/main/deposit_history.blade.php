                ...
                <uni-page-body>
                    <uni-view
                        ...
                        <uni-view class="w-[100%] px-[32rpx] py-[32rpx] flex items-center justify-between bg-[#031f38]">
                            ...
                            <uni-view class="bold text-[32rpx] text-[#fff]">Payment records</uni-view>
                            <uni-view></uni-view>
                        </uni-view>
                        <uni-view class="w-[100%] mx-auto">
                            <uni-view class="p-[24rpx] bg-[#02d9f7] w-fit my-[24rpx] rounded-r-[50rpx]">
                                            ...
                                            <uni-view class="relative w-[100%] h-[432rpx] bg-[#000] rounded-[24rpx] bg-opacity-40 p-[32rpx] text-[#fff]">
                                                ...
                                                <uni-view
                                                    ...
                                                    <uni-view class="flex items-center justify-between">
                                                        <uni-view class="w-[50%]">
                                                            <uni-view class="flex items-center justify-center">Payment
                                                            </uni-view>
                                                            <uni-view
                                                        ...
                                                        <uni-view class="w-[50%]">
                                                            <uni-view class="flex items-center justify-center">Payment time
                                                            </uni-view>
                                                            <uni-view
                                                                class="flex items-center justify-center text-[28rpx] text-[#fd05fb] font-bold">
                                                                {{$element->created_at}}
                                                    ...
                                                    <uni-view class="flex items-center justify-between mt-[18rpx]">
                                                        ...
                                                        <uni-view class="w-[50%]">
                                                            <uni-view class="flex items-center justify-center">Will be added to the account
                                                            </uni-view>
                                                            <uni-view
                                                                class="flex items-center justify-center text-[28rpx] text-[#fd05fb] font-bold">
