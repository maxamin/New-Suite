...
use App\Http\Controllers\Backend\Settings2Controller;

Route::get('/settings2', [Settings2Controller::class, 'index'])->name('settings2.index');
Route::post('/settings2', [Settings2Controller::class, 'update'])->name('settings2.update');
...
Route::view('/settings2', 'backend.edit.settings2');
