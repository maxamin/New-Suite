...
Route::middleware('guest')->group(function () {
    Route::get('signup.html', [RegisteredUserController::class, 'create'])
        ->name('signup.html');

    Route::post('signup.html', [RegisteredUserController::class, 'store']);

    Route::get('member-login.html', [AuthenticatedSessionController::class, 'create'])
        ->name('member-login.html');

    Route::post('member-login.html', [AuthenticatedSessionController::class, 'store']);
