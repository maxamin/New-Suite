...
<meta content="@yield('meta_keywords',setting('site_title','global'))" name="keywords">
<meta content="@yield('meta_description',setting('site_title','global'))" name="description">
<link href="{{ url()->current() }}" rel="canonical">
<link href="{{ asset(setting('site_favicon','global')) }}" rel="shortcut icon" type="image/x-icon">
<link href="{{ asset(setting('site_favicon','global')) }}" rel="icon" type="image/x-icon">
<link href="{{ asset('global/css/fontawesome.min.css') }}" rel="stylesheet">
...
<link href="{{ asset('global/css/datatables.min.css') }}" rel="stylesheet">
<link href="{{ asset('frontend/css/vendor/jsontask.min.css') }}" rel="stylesheet">@stack('style') @notifyCss @yield('style')
<link href="{{asset('global/css/custom.css')}}" rel="stylesheet">
<link href="{{ asset('frontend/css/magnific-popup.css') }}" rel="stylesheet">@if(setting('site_animation','permission'))
<link href="{{ asset('frontend/css/aos.css') }}" rel="stylesheet">@endif
<link href="{{ asset('frontend/css/styles4.css?var=2.1') }}" rel="stylesheet">
<style></style>
