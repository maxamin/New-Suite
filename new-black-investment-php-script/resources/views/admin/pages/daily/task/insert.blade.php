                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <a href="{{route('admin.task.index')}}" class="btn btn-primary btn-sm"> <i
                                                class="bx bx-left-arrow"></i> Tasks List</a>
                                    </div>
                                </div>
                            </h4>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <select name="type_id"  class="form-control is-valid" required>
                                            @foreach($types as $type)
                                                <option value="{{ $type->id }}" @if($data && $data->type_id == $type->id) selected @endif>{{ $type->name }}</option>
                                            @endforeach
                                    ...
                                    <div class="col-sm-6">
                                        <label for="number">Invitation Number Required</label>
                                        <input type="text" class="form-control is-valid"
                                               name="number" id="number"
                                               placeholder="Ref Number" value="{{$data ? $data->number : ''}}" required>
                                        <div class="valid-feedback">
                                            <i class="bx bx-radio-circle"></i>
                                            Note: This is filed is required
                                        </div>
