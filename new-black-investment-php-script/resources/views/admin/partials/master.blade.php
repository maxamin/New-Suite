...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation"
            ...
            <li class="nav-item {{ menuActive(['admin.package.index', 'admin.package.create', 'admin.section.create', 'admin.section.insert',
                'admin.category.index', 'admin.category.create'], 'sidebar-group-active open active') }}">
                <a href="#"> <i class="bx bx-right-arrow"></i> <span class="menu-title" data-i18n="Invoice">Package</span></a>
                <ul class="menu-content">
                    <li class="@if($route == 'admin.package.index') active @else @endif">
                        <a href="{{route('admin.package.index')}}"><i class="bx bx-right-arrow-alt"></i><span
                                class="menu-item" data-i18n="Section">List</span></a></li>

                    <li class="{{ menuActive(['admin.category.index', 'admin.category.create']) }}">
                        <a href="{{route('admin.category.index')}}"><i class="bx bx-right-arrow-alt"></i><span
                                class="menu-item" data-i18n="Section">Category</span></a></li>
                </ul>
            </li>
            ...
            <li class="nav-item @if($route == 'admin.bonus.index' || $route == 'admin.bonus.create' || $route == 'admin.bonus.insert' || $route == 'admin.bonuslist.index') sidebar-group-active open active @else @endif">
                <a href="#"> <i class="bx bx-right-arrow"></i> <span class="menu-title" data-i18n="Invoice">Gift Bonus</span></a>
                <ul class="menu-content">
                    ...
                    <li class="@if($route == 'admin.bonuslist.index') active @else @endif">
                        <a href="{{route('admin.bonuslist.index')}}"><i class="bx bx-right-arrow-alt"></i><span
                                class="menu-item" data-i18n="Section">Uses List</span></a></li>
                </ul>
            </li>

            <li class="nav-item {{ menuActive(['admin.task.index', 'admin.task.create', 'admin.checkin.index', 'admin.checkin.create'], 'sidebar-group-active open active') }}">
                <a href="#"> <i class="bx bx-right-arrow"></i> <span class="menu-title" data-i18n="Invoice">Daily Offer</span></a>
                <ul class="menu-content">
                    <li class="@if($route == 'admin.task.index') active @else @endif">
                        <a href="{{route('admin.task.index')}}"><i class="bx bx-right-arrow-alt"></i><span
                                class="menu-item" data-i18n="Section">Tasks</span></a></li>

                    <li class="{{ menuActive(['admin.checkin.index', 'admin.checkin.create']) }}">
                        <a href="{{route('admin.checkin.index')}}"><i class="bx bx-right-arrow-alt"></i><span
                                class="menu-item" data-i18n="Section">Check-ins</span></a></li>
                </ul>
            </li>

            <li class="{{ menuActive(['admin.type.index', 'admin.type.create'], 'active') }}">
                <a href="{{route('admin.type.index')}}"><i class="bx bx-right-arrow-alt"></i><span
                        class="menu-item" data-i18n="Section">VIP Type</span></a></li>

            <li class="{{ menuActive(['admin.customer.index', 'admin.customer.update'], 'active') }}">
                <a href="{{route('admin.customer.index')}}"><i class="bx bx-right-arrow-alt"></i><span
                        class="menu-item" data-i18n="Section">Customers</span></a></li>
            ...
            <li class="nav-item @if($route == 'admin.payment.pending' || $route == 'admin.payment.rejected' || $route == 'admin.payment.approved') sidebar-group-active open active @else @endif">
                <a href="#"> <i class="bx bx-right-arrow"></i> <span class="menu-title" data-i18n="Invoice">Recharge Payments</span></a>
                <ul class="menu-content">
                    <li class="@if($route == 'admin.payment.pending') active @else @endif">
                        <a href="{{route('admin.payment.pending')}}"><i class="bx bx-right-arrow-alt"></i><span
                                class="menu-item" data-i18n="Section">Pending</span></a></li>
                    <li class="@if($route == 'admin.payment.approved') active @else @endif">
                        <a href="{{route('admin.payment.approved')}}"><i class="bx bx-right-arrow-alt"></i><span
                                class="menu-item" data-i18n="Section">Approved</span></a></li>
                    <li class="@if($route == 'admin.payment.rejected') active @else @endif">
                        <a href="{{route('admin.payment.rejected')}}"><i class="bx bx-right-arrow-alt"></i><span
                                class="menu-item" data-i18n="Section">Rejected</span></a></li>
                    {{-- <li class="@if($route == 'admin.usdt.index') active @else @endif">
                        <a href="{{route('admin.usdt.index')}}"><i class="bx bx-right-arrow-alt"></i><span
                                class="menu-item" data-i18n="Section">USDT</span></a></li> --}}
                </ul>
            </li>
            ...
            <li class="nav-item @if($route == 'admin.withdraw.pending' || $route == 'admin.withdraw.rejected' || $route == 'admin.withdraw.approved') sidebar-group-active open active @else @endif">
                <a href="#"> <i class="bx bx-right-arrow"></i> <span class="menu-title" data-i18n="Invoice">Withdrawal Payments</span></a>
                <ul class="menu-content">
            ...
            {{-- <li class="@if($route == 'admin.notice.index') active @else @endif">
                <a href="{{route('admin.notice.index')}}"><i class="bx bx-right-arrow-alt"></i><span
                        class="menu-item" data-i18n="Section">Users Notice</span></a>
            </li> --}}

            <li class="{{ menuActive(['admin.news'], 'active') }}">
                <a href="{{route('admin.news')}}"><i class="bx bx-right-arrow-alt"></i><span
                        class="menu-item" data-i18n="Section">Blog/News</span></a>
            </li>

            <li class="{{ menuActive(['admin.vipslider.index', 'admin.vipslider.create', 'admin.vipslider.insert'], 'active') }}">
                <a href="{{route('admin.vipslider.index')}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Section">Slider Images</span></a>
            </li>

            <li class="nav-item {{ menuActive(['admin.method.index', 'admin.method.create', 'admin.method.insert'], 'sidebar-group-active open active') }}">
                ...
                <ul class="menu-content">
                    ...
                    <li class="@if($route == 'admin.setting.index' || $route == 'admin.setting.create' || $route == 'admin.setting.insert') active @else @endif">
                        <a href="{{route('admin.setting.index')}}"><i class="bx bx-right-arrow-alt"></i><span
                                class="menu-item" data-i18n="Section">Basic</span></a></li>
                    
                    <li class="{{ menuActive(['admin.rebate.index'], 'active') }}">
                        <a href="{{route('admin.rebate.index')}}"><i class="bx bx-right-arrow-alt"></i><span
                                class="menu-item" data-i18n="Section">Commission</span></a></li>
                    ...
                    <li class="@if($route == 'admin.method.index' || $route == 'admin.method.create' || $route == 'admin.method.insert') active @else @endif">
                        <a href="{{route('admin.method.index')}}"><i class="bx bx-right-arrow-alt"></i><span
                                class="menu-item" data-i18n="Section">Payment Methods</span></a></li>
                </ul>
            </li>
        </ul>
    </div>
...
<footer class="footer footer-static footer-light">
    <p class="clearfix mb-0"><span class="float-left d-inline-block">{{ date('Y') }} &copy; Muongozo Trader</span><span
            class="float-right d-sm-inline-block d-none">Developed by <a class="text-uppercase"
                                                                      href="https://t.me/muongozotrader"
                                                                      target="_blank">@muongozotrader</a></span>
