...
class IpnOxaPayController extends Controller
{
    ...
    public static function updateDeposit(
        ...
        try {
            ...
            $transaction->order_currency = $wallet->currency;
            $transaction->order_amount = $actual_receive_amount;
            $transaction->rate = $wallet->bank->rate;
            ...
            // Update user balance
            $user->balance = $user->balance + $actual_receive_amount;
            $user->save();
