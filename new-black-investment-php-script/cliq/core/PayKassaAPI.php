<?php
    class PayKassaAPI {
        ...
        public function api_payment($shop, $system, $number, $amount, $currency, $comment, $paid_commission='', $tag='', $real_fee=false, $priority='medium', $test=false) {
            $fields = ["shop", "system", "number", "amount", "currency", "comment", "paid_commission", "tag", "real_fee", "priority", "test", ];
            return $this->query($this->url, [
                "func" => "api_payment",
            ] + compact($fields));
        }
