...
Route::middleware('throttle:limit-check')->group(function (){
    ...
    */
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::get('/deposit-pay/{amount}/{method}', [UserController::class, 'recharge_amount'])->name('user.deposit.amount');
        Route::post('/payment-confirmation', [UserController::class, 'depositSubmit'])->name('payment_confirmation');
        Route::get('deposit/pay/{network?}', [UserController::class, 'recharge'])->name('deposit.confirm');
...
Route::post('ipn/oxapa00xcd', [IpnOxaPayController::class, 'ipn'])->name('ipn.oxapay');
