...
<body __processed_d4888afc-141c-4e40-8b5d-786cb037dd77__="true"
        ...
        <div data-v-79efa3b4="" class="recharge" bis_skin_checked="1">
            ...
            <section data-v-79efa3b4="" class="section-box">
                ...
                <div data-v-79efa3b4="" class="boxed" bis_skin_checked="1">
                    <div data-v-79efa3b4="" class="signin" bis_skin_checked="1"><img data-v-79efa3b4=""
                            src="data:image/png;base64,"
                            alt="">
                        <p data-v-79efa3b4="">Scan QR or Copy Address</p>
                    </div>

                    <div data-v-eb7799e8="" class="qrcode" id="qrcode" title="{{ $wallet->address }}" style="margin-bottom: 10px;">
                        <canvas width="140" height="140" style="display: none;"></canvas>
                    </div>
                    <p>Address</p>
                    <p style="margin-bottom: 15px;" onclick="copyLink('{{ $wallet->address }}')"><b>{{ $wallet->address }}</b></p>

                    <div data-v-79efa3b4="" bis_skin_checked="1">

                        <div data-v-79efa3b4="" class="signin seletwo" bis_skin_checked="1"><img data-v-79efa3b4=""
                                src="data:image/png;base64,"
                                alt="">
                            <p data-v-79efa3b4="">Current Network: <b>{{ strtoupper($wallet->network) }}</b></p>
                        </div>
                        ...
                        <div data-v-79efa3b4=""style="width:100%;" class="van-cell van-field input-box"
                            ...
                            <div class="van-cell__value van-cell__value--alone van-field__value" bis_skin_checked="1">
                                <div class="van-field__body" bis_skin_checked="1">
                                    <select id="pay_method" class="van-field__control">
                                        @foreach ($methods as $method)
                                            <option
                                                data-link="{{ route('deposit.confirm', ['network' => $method->bank_code]) }}"
                                                value="{{ $method->bank_code }}" @if ($network == $method->bank_code) selected @endif>
                                                {{ $method->name }}</option>
                                        @endforeach
                                    </select>
                                    <!---->
    ...
    <script src="{{ asset('public/js/qrcode.js') }}"></script>
