...
<head>
    ...
    <title>Gold Mines |Package Details</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset ('dash2/p/760.008f9504.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset ('dash2/p/449.267cc180.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset ('dash2/p/803.defe3160.css')}}">
</head>
@include('preloader')
<body __processed_4d357f34-f015-490f-a0de-35dd442dcff0__="true"
    ...
    <div id="app" data-v-app="" bis_skin_checked="1">
        <div data-v-2668f902="" class="homedetail" bis_skin_checked="1">
            <div data-v-2668f902="" class="nav-top" bis_skin_checked="1">
                <div data-v-2668f902="" class="van-nav-bar van-hairline--bottom" bis_skin_checked="1">
                    <div class="van-nav-bar__content" bis_skin_checked="1">
                        <div onclick="window.location.href='{{route ('vip')}}'"  class="van-nav-bar__left van-haptics-feedback" bis_skin_checked="1"><img data-v-2668f902="" src="data:image/png;base64," alt="">
                        </div>
                        <div class="van-nav-bar__title van-ellipsis" bis_skin_checked="1"></div>
                        <!---->
                    </div>
                </div>
                <div data-v-2668f902="" class="van-image imgtop" bis_skin_checked="1"><img src="{{asset($package->photo)}}" class="van-image__img">
                    <!---->
                    <!---->
                </div>
            </div>
            <section data-v-2668f902="" class="section-box">
                <div data-v-2668f902="" class="details" bis_skin_checked="1">
                    <div data-v-2668f902="" class="signin" bis_skin_checked="1">
                        <p data-v-2668f902="" class="bold">{{$package->name}}</p>
                    </div>
                    <div data-v-2668f902="" class="effective" bis_skin_checked="1">
                      
                        <div data-v-2668f902="" class="list-time lastitem" bis_skin_checked="1">
                            <div data-v-2668f902="" class="time" bis_skin_checked="1">
                                <p data-v-2668f902="">Daily income</p>
                            </div>
                            <p data-v-2668f902="" class="dayst">{{currency()}}{{($package->commission_with_avg_amount / $package->validity)}}</p>
                        </div>
                        <div data-v-2668f902="" class="list-time lastitem" bis_skin_checked="1">
                            <div data-v-2668f902="" class="time" bis_skin_checked="1">
                                <p data-v-2668f902="">Total income</p>
                            </div>
                            <p data-v-2668f902="" class="dayst">{{currency()}}{{($package->commission_with_avg_amount)}}</p>
                        </div>
                        <div data-v-2668f902="" class="list-time" style="border: none;" bis_skin_checked="1">
                            <div data-v-2668f902="" class="time" bis_skin_checked="1">
                                <p data-v-2668f902="">Effective time</p>
                            </div>
                            <p data-v-2668f902="" class="dayst">{{$package->validity}} days</p>
                        </div>
                    </div>
                    <p data-v-2668f902="" class="product">Each member can invest in this project repeatedly to increase
                        your daily income.
                        Earnings will automatically reach the account balance every hour, and the distribution of income
                        will stop after maturity.</p>
                </div>
                <div data-v-2668f902="" class="wrap-btn" bis_skin_checked="1">
                    <p data-v-2668f902="" class="l-price">{{currency()}}{{($package->price)}}</p>
                      <?php
                        $myPackage = \App\Models\Purchase::where('user_id', user()->id)->where('package_id', $package->id)->where('status', 'active')->first();
                        ?>
                             @if($myPackage)
                    <button data-v-2668f902="" class="btndetail"> Sold Out </button>
                   @else
                     <button data-v-2668f902="" onclick="window.location.href='{{route('purchase.confirmation', $package->id)}}'" class="btndetail"> Buy </button>
                       @endif
                    <!---->
                </div>
            </section>
